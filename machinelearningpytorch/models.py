        ...
        with no_grad():
            ...
            while True:
                ...
                for data in dataloader:
                    inp, label = data['x'], data['label']
                    target = 1 if label >= 0 else -1
                    if self.get_prediction(inp) != target:
                        self.w = Parameter(self.w + (target * inp))
                        conv = True
                        break
                if not conv:
                    break
...
class RegressionModel(Module):
    ...
    def __init__(self):
        ...
        self.layer1 = Linear(1, 50)
        self.layer2 = Linear(50, 25)
        self.layer3 = Linear(25, 1)
